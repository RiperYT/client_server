...
public class EmployeeDto extends BaseDto{
    ...
    public EmployeeDto(String id_employee, String empl_surname, String empl_name, String empl_patronymic, String empl_role, BigDecimal salary, OffsetDateTime date_of_birth, OffsetDateTime date_of_start, String phone_number, String city, String street, String zip_code, String password) {
    ...
    public OffsetDateTime getDate_of_birth() {
        return date_of_birth;
    }

    public void setDate_of_birth(OffsetDateTime date_of_birth) {
        this.date_of_birth = date_of_birth;
    }
